...
const section5 = (props) => {
    return (
        <Fragment>
            ...
            <div className="absolute bottom-[7rem] lg:bottom-0 w-[79vh] lg:w-[88vh] right-0 lg:right-[6rem] bottom-[4rem] hminxl800:w-[75vh] hminxl800:right-[12rem] hminMaxSm:w-[54vh] hminMaxSm:bottom-0 hminMaxSm:left-1/2 hminMaxSm:-translate-x-1/2 hminMaxSm700:w-[54vh] hminMaxSm700:bottom-0 hminMaxSm700:left-1/2 hminMaxSm700:-translate-x-1/2">
            ...
            <div className="container relative h-full">
                <div className="absolute left-0 top-[14vh] md:top-auto md:bottom-[7vh] pl-[1rem] xl:pl-0">
                    ...
                    <p className='text__20 text-white'>Embark on a journey from rookie to motocross <br className='hidden xs:block' /> legend in our immersive career mode. Blaze your <br className='hidden xs:block' /> own trail, conquer challenges, and rise to the top of <br className='hidden xs:block' /> the motocross world</p>
