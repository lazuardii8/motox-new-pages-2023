...
const section2 = (props) => {
    return (
        <Fragment>
            <img src="./../images/line 2.svg" className='absolute hidden md:block -right-[5rem] -bottom-[16rem] w-[94vh] hminxl800:w-[85vh] hminxl800:-right-[6rem] hminxl900:-right-[14rem] hminxl800:-bottom-[10rem]' alt="" />
            ...
            <img src="./../images/layer 3.svg" className='absolute lg:left-0 md:!bottom-0 h-full object-cover -bottom-[14rem] left-0 object-[23%] hminSm700:-bottom-[14rem] hminSm700:object-[23%] hminSm700:left-0' alt="" />
            <div className="absolute left-0 bottom-0 w-[72vh] -left-[1rem] xx:-left-[2rem] xx:w-[80vh] xs:!left-0 sm:!w-[124vh]">
