...
const section2 = (props) => {
    return (
        <Fragment>
            ...
            <img src="./../images/layer 3.png" className='absolute lg:left-0 md:!bottom-0 h-full object-cover -bottom-[14rem] left-0 object-[23%] hminSm700:-bottom-[14rem] hminSm700:object-[23%] hminSm700:left-0 hminlg950:!object-[94%] hminlg1100:!object-[74%] hminmd1024:!object-[70%]' alt="" />
            <div className="absolute left-0 bottom-0 w-[72vh] -left-[1rem] xx:-left-[2rem] xx:w-[80vh] xs:!left-0 sm:!w-[124vh] hminlg950:!w-[100vh] hminlg1100:!w-[95vh] hminmd1024:!w-[90vh]">
